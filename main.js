const API_KEY = "63b61cd9-2e33-449c-9c25-b10e64a26c59";
  ...
  data.films.forEach((movie) => {
    ...
    movieElements.innerHTML = `
      ...
      <div class="movie__info">
        ...
        `;
    movieElements.addEventListener("click", () => openModal(movie.filmId))
    moviesEl.appendChild(movieElements);
  });
}
...
async function openModal(id) {
  ...
  modalWindow.innerHTML = `
    <div class="modal__card">
      ...
      <h2>
        <span class="modal__movie-title" style="margin: 0 0 0 25px; padding: 25px 0 0 0;">${respData.nameRu}</span>
